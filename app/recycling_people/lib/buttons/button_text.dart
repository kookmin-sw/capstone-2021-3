...
class _ButtonText extends State<ButtonText> {
  ...
  final List<String> type_list = [
    '캔류', '종이', '플라스틱', '유리', '페트', '비닐류', '종이팩', '스티로폼', 'None'
  ]; 
  ...
  Widget build(BuildContext context) {
      ...
      child: Container(
        ...
        decoration: new BoxDecoration(
          ...
          border: new Border.all(color: type_map[type_list[type_index]], width: 2.0),
          borderRadius: new BorderRadius.circular(5.0),
          ),
        child: Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: <Widget>[
                Image.asset('assets/recyleTypeImage/${type_list[type_index]}.jpg'),
                Text(
                ...
                Text(this.blanck.substring(0, 2*type_list[type_index].length)) // 보일려는 글자의 2배 크기의 space 만들기
              ]
            )
      ) 
    );
